...
////
= Downloading Apache NetBeans 30
:page-layout: page_noaside
:page-tags: download
:jbake-status: published
:keywords: Apache NetBeans 30 Download
:description: Apache NetBeans 30 Download
:toc: left
:toc-title:
:icons: font
...
Apache NetBeans {netbeans-version} was released on May 18, 2026.
// TODO update date                                ^^^^
...
Apache NetBeans {netbeans-version} supports running on JDK 26, 25 or 21.
...
- link:https://lists.apache.org/thread/lgd406gj34oylrwhv8o5x30kykcyw4d3[PMC vote]
- link:https://lists.apache.org/thread/k9gvzw5t74x1d6yq6yfgpcno1q4vf24z[PMC vote result]
// TODO update links                   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
