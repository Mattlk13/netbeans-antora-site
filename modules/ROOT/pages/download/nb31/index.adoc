...
:keywords: Apache NetBeans 31 Download
:description: Apache NetBeans 31 Download
:toc: left
:toc-title:
:icons: font
...
Apache NetBeans {netbeans-version} was released on August 10, 2026.
// TODO update date                                ^^^^
...
Apache NetBeans {netbeans-version} supports running on JDK 26, 25 or 21 (with initial support for JDK 27).
...
- link:https://lists.apache.org/thread/pkk3s7wkmqbv9sdxcclyqdkx4xtkm1n8[PMC vote]
- link:https://lists.apache.org/thread/99wd5ptdp1to71hrf196qrz2dog88246[PMC vote result]
// TODO update links                   ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
